    ...
    <div className="space-y-4">
      ...
      <div className="border rounded p-3">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <div>
            <div className="text-sm text-slate-600 mb-1">Wzorzec &ndash; fala</div>
            <canvas ref={refWaveRef} width={600} height={140} className="w-full border rounded" />
          </div>
          <div>
            <div className="text-sm text-slate-600 mb-1">Wzorzec &ndash; pitch / pasmo</div>
      ...
      <div className="border rounded p-3">
        <div className="grid md:grid-cols-2 gap-3">
          <div>
            <div className="text-sm text-slate-600 mb-1">Użytkownik &ndash; fala</div>
            <canvas ref={micWaveRef} width={600} height={140} className="w-full border rounded" />
          </div>
          <div>
            <div className="text-sm text-slate-600 mb-1">Użytkownik &ndash; pitch / pasmo</div>
        ...
        {recordUrl && (
          <div className="mt-2">
            ...
            <a className="text-sm underline" href={recordUrl} download={`nagranie-${Date.now()}.webm`}>
              Pobierz nagranie
            </a>
          </div>
        )}
